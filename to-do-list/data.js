...
export const appHTML = {
  html: `<section class="remaining">
        <div class="tableInfo">
          <span>Remaining Tasks <span id="countRemainingTask">0</span></span>
  ...
  countRemainingTask() {return document.querySelector('#countRemainingTask')}
...
export const initial ={
    html:`<div id="starter-page">
            ...
            <h4>Follow me on:</h4>
            <p>GitHub -</p>
            <a href="https://github.com/Dnyaneshpise/" target="_blank">@DnyaneshPise</a>
          </div>
